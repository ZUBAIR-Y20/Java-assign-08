...
document.addEventListener('DOMContentLoaded', function () {
    const students = [
        ...
        { id: 2, name: 'Sherjeel', grade: 'A+' },
        { id: 3, name: 'Muhammad Yusuf', grade: 'A+' },
        { id: 4, name: 'Noor Talha', grade: 'A' },
        { id: 5, name: 'Sheriyar', grade: 'B' },
        { id: 6, name: 'Sameer', grade: 'B' },
        { id: 7, name: 'Imran', grade: 'C' },
        { id: 8, name: 'Shahnawaz', grade: 'C' },
        { id: 9, name: 'Wasim', grade: 'D' },
        { id: 10, name: 'Arfeen', grade: 'D' },
